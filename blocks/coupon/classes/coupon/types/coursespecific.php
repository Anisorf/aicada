...
/**
 * block_coupon\coupon\types\coursespecific
 *
 * @package     block_coupon
 *
 * @copyright   Sebsoft.nl
...
class coursespecific extends typebase implements icoupontype {
    ...
    public function claim($foruserid = null, $options = null) {
        ...
        // Validate.
        if ($this->coupon->typ !== \block_coupon\coupon\generatoroptions::COURSESPECIFIC) {
        ...
        // F: enrol, insert a new record to block_coupon_courses of coupon id course id
