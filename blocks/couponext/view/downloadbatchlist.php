...
$url = new moodle_url($CFG->wwwroot . '/blocks/couponext/view/downloadbatchlist.php', array('id' => $id));
$PAGE->set_url($url);
...
$controller = new block_couponext\controller\downloadbatches($PAGE, $OUTPUT, $renderer);
