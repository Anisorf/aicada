...
// Prepare.
try {
    $options = block_couponext\coupon\generatoroptions::from_session();
} catch (Exception $ex) {
    $options = new block_couponext\coupon\generatoroptions();
}
...
// Generate the PDF.
$pdfgen = new block_couponext\coupon\pdf(get_string('pdf:titlename', 'block_couponext'));
