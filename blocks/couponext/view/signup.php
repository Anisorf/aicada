...
$PAGE->set_url('/blocks/couponext/view/signup.php');
$PAGE->set_context(context_system::instance());

// If wantsurl is empty or /blocks/couponext/view/signup.php, override wanted URL.
...
$mformsignup = new \block_couponext\forms\coupon\signup();
...
if ($mformsignup->is_cancelled()) {
    ...
    // Added for coupon.
    \block_couponext\helper::claim_coupon($user->submissioncode, $user->id);
    // Unset sessionurl.
...
if (get_config('block_couponext', 'useloginlayoutonsignup')) {
...
echo html_writer::link($loginurl, get_string('signup:login', 'block_couponext'));
echo '<hr/>';
