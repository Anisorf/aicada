...
use block_couponext\forms\coupon\generator\chooser;
...
$url = new moodle_url($CFG->wwwroot . '/blocks/couponext/view/generator/index.php', array('id' => $id));
$PAGE->set_url($url);
...
if ($mform->is_cancelled()) {
    ...
    switch ($generatoroptions->type) {
        case generatoroptions::COURSE:
            $redirect = new moodle_url($CFG->wwwroot . '/blocks/couponext/view/generator/course.php',
                    ['id' => $id]);
            break;
        ...
        default:
            // Try autodetect.
            $redirect = new moodle_url($CFG->wwwroot . '/blocks/couponext/view/generator/' .
