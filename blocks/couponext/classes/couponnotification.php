...
/**
 * block_couponext\couponnotification
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class couponnotification {
    ...
    protected static function initialize_message($subject = null) {
        ...
        $message->component = 'block_couponext';
    ...
    public static function send_notification($userid, $batchid, $ts) {
        ...
        $course = $site;
        $contextname = get_string('pluginname', 'block_couponext');
        $contexturl = new \moodle_url($CFG->wwwroot . '/blocks/couponext/view/couponview.php',
        ...
        $subject = get_string('coupon_notification_subject', 'block_couponext', $a);
        $fullmessage = get_string('coupon_notification_content', 'block_couponext', $a);
    ...
    public static function send_request_accept_notification($userid, $batchid, $ts, $extramessage = '') {
        ...
        $course = $site;
        $contextname = get_string('pluginname', 'block_couponext');
        $contexturl = new \moodle_url($CFG->wwwroot . '/blocks/couponext/view/requests/userrequest.php',
        ...
        $fullmessage = get_string('request:accept:content', 'block_couponext', $a);
        $smallmessage = $fullmessage;
    ...
    public static function send_task_notification($userid, $batchid, $timeexecuted) {
        ...
        $a->batchid = $batchid;
        $subject = get_string('confirm_coupons_sent_subject', 'block_couponext', $a);
        $fullmessage = get_string('confirm_coupons_sent_body', 'block_couponext', $a);
        $smallmessage = get_string('confirm_coupons_sent_body', 'block_couponext', $a);
