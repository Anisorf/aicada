...
/**
 * Maillog implementation for use with block_couponext
 *
 * File         maillog.php
 * Encoding     UTF-8
 *
...
/**
 * block_couponext\manager\maillog
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class maillog {
    ...
    public function execute_request() {
        ...
        $url = new moodle_url($CFG->wwwroot . '/blocks/couponext/view/maillog.php', array('id' => $id, 'tab' => $tab));
    ...
    protected function process_overview() {
        ...
        // Table instance.
        $table = new \block_couponext\tables\maillog($ownerid);
        $table->baseurl = $this->page->url;

        $filtering = new \block_couponext\tablefilters\maillog($this->page->url);
