...
/**
 * block_couponext\forms\coupon\cohort\page1
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class page1 extends \moodleform {
    ...
    public function definition() {
        ...
        if (!$strinfo = get_config('block_couponext', 'info_coupon_cohorts')) {
        ...
        $mform->addElement('header', 'header', get_string('heading:input_cohorts', 'block_couponext'));
        ...
        $selectcohorts = &$mform->addElement('select', 'coupon_cohorts',
                get_string('label:coupon_cohorts', 'block_couponext'), $arrcohortselect, $attributes);
        $selectcohorts->setMultiple($multiselect);
        $mform->addRule('coupon_cohorts', get_string('error:required', 'block_couponext'), 'required', null, 'client');
        $mform->addHelpButton('coupon_cohorts', 'label:coupon_cohorts', 'block_couponext');
