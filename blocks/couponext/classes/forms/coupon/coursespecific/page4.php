...
/**
 * course specific coupon generator form (step 4)
 *
 * File         page4.php
 * Encoding     UTF-8
 *
...
/**
 * block_couponext\forms\coupon\coursespecific\page4
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class page4 extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'lastSettings', get_string('heading:general_settings', 'block_couponext'));

        // Configurable redirect url.
        $mform->addElement('text', 'redirect_url', get_string('label:redirect_url', 'block_couponext'));
        ...
        // $mform->addElement('static', 'coupon_courses', get_string('label:selected_courses', 'block_couponext'), $courses);
