...
/**
 * block_couponext\forms\coupon\course\page5
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class page5 extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('textarea', 'coupon_recipients',
                get_string("label:coupon_recipients", 'block_couponext'), 'rows="20" cols="50"');
        $mform->addRule('coupon_recipients', get_string('required'), 'required', null, 'client');
        $mform->addHelpButton('coupon_recipients', 'label:coupon_recipients_txt', 'block_couponext');
