 ...
 */
namespace block_couponext\forms\element;
...
class findcourses extends MoodleQuickForm_autocomplete {
    ...
    public function __construct($elementname = null, $elementlabel = null, $options = array()) {
        $validattributes = array(
            'ajax' => 'block_couponext/findcourses',
            'multiple' => true
        );
        ...
        $validattributes['placeholder'] = get_string('findcourses:placeholder', 'block_couponext');
        $validattributes['noselectionstring'] = get_string('findcourses:noselectionstring', 'block_couponext');
