...
class findusers extends MoodleQuickForm_autocomplete {
    ...
    public function __construct($elementname = null, $elementlabel = null, $options = array()) {
        $validattributes = array(
            'ajax' => 'block_couponext/findusers',
        );
        ...
        $validattributes['placeholder'] = get_string('findusers:placeholder', 'block_couponext');
        $validattributes['noselectionstring'] = get_string('findusers:noselectionstring', 'block_couponext');
