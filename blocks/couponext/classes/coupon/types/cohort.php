...
/**
 * block_couponext\coupon\types\cohort
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class cohort extends typebase implements icoupontype {
    ...
    public function claim($foruserid = null, $options = null) {
        ...
        // Validate.
        if ($this->coupon->typ !== \block_couponext\coupon\generatoroptions::COHORT) {
        ...
        $couponcohorts = $DB->get_records('block_couponext_cohorts', array('couponid' => $this->coupon->id));
