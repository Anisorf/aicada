 ...
 *
 * File         couponcoursegroupselect.php
 * Encoding     UTF-8
 *
...
/**
 * block_couponext\filters\couponcoursegroupselect
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class couponcoursegroupselect extends \user_filter_type {
    /** @var string */
    protected $fieldid;
    ...
    public function __construct($advanced, $fieldid = 'id') {
        ...
        parent::__construct('couponcoursegroupselect', get_string('course') . ' ID', $advanced);
    }
    ...
    public function get_coursemenu() {
        global $DB;
        return array(0 => '...') + $DB->get_records_menu('groups', null, 'name ASC', 'id,name');
    }
