...
/**
 * block_couponext\filters\couponbatchselect
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class couponbatchselect extends \user_filter_type {
    ...
    public function __construct($advanced, $fieldid = 'id') {
        ...
        parent::__construct('batchselect', get_string('batchidselect', 'block_couponext'), $advanced);
    }
    ...
    public function get_batchmenu() {
        global $DB;
        return array(0 => '...') + $DB->get_records_sql_menu('select distinct batchid as id, batchid as name from {block_couponext}');
    }
