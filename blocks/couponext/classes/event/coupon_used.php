 ...
 **/
namespace block_couponext\event;
...
/**
 * block_couponext\event\coupon_used
 *
 * @package     block_couponext
 *
 * @copyright   Sebsoft.nl
...
class coupon_used extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'block_couponext';
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('event:coupon:used', 'block_couponext');
    }
